...
TestObjs *setup(void) {
  ...
  objs->test_str_5 = (const unsigned char *) "art..)";
  objs->test_str_6 = (const unsigned char *) "ar..)t";
...
void test_trim_non_alpha(TestObjs *objs) {
  ...
  strcpy((char *) buf, (const char *) objs->test_str_5);
  ASSERT(0 == strcmp("art..)", (const char *) buf));
  wc_trim_non_alpha(buf);
  ASSERT(0 == strcmp("art", (const char *) buf));

  strcpy((char *) buf, (const char *) objs->test_str_6);
  ASSERT(0 == strcmp("ar..)t", (const char *) buf));
  wc_trim_non_alpha(buf);
  ASSERT(0 == strcmp("ar..)t", (const char *) buf));
}
